...
Perhaps I had been spoiled by my own creation, [Context Caddy](/context-caddy/), which is a VScode extension I made that essentially let me use any typical chat assistant with the same kind of context file picker that Cursor apparently uses.
